...
export class PostProductComponent implements OnInit {
  ...
  constructor( public data: DataService, private rest: RestApiService, private router: Router) { }
       ...
       if (product.price){
       	if (product.categoryId) {
       		if (product.description) {
       			...
       			this.data.error('please enter product description.');
       		}
       	}else{
